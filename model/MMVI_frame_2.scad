...
difference() {
    ...
    plate(l = H_BRIDGE_LOWER_L + SENSOR_TOTAL_H - 1, w = H_BRIDGE_LOWER_W + 2 * SENSOR_TOTAL_H - 6, h = H_BRIDGE_UPPER_H + 1, xt = 103, yt = -H_BRIDGE_LOWER_W / 2 - SENSOR_TOTAL_H + 3, zt = 8 + GROUND_OFFSET, color = "DarkViolet");
    ...
    // side-of-H-bridge wiring cutout
