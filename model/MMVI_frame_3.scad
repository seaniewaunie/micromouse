...
union() {
    ...
    difference() {
        ...
        driven_wheel_system(xt = 120 + 0.75, zt = GROUND_OFFSET);

        // open space between motors
        plate(l = MOTOR_BODY_W + 1.5, w = 62, h = MOTOR_BODY_H + 4, xt = 115, yt = -31, zt = GROUND_OFFSET  - (MOTOR_BODY_H / 2 ), color = "DarkViolet");
        
        // open space between motors
        plate(l = MOTOR_BODY_W + 1.5, w = MOTOR_BODY_L, h = MOTOR_BODY_H + 4, xt = 115, yt = 17.2 - MOTOR_BODY_L / 2, zt = GROUND_OFFSET  - (MOTOR_BODY_H / 2 ), color = "DarkViolet");
        ...
        rotate([90, 0, 0]) {
            translate([120 + .75, GROUND_OFFSET, -35.5]) {
                color("DarkViolet") {
        ...
        rotate([90, 0, 0]) {
            translate([120 + .75, GROUND_OFFSET, 30]) {
                color("DarkViolet") {
                    cylinder(d = 5, h = MOTOR_SHAFT_H / 2, center="true");
                }
            }
...
union() {
    ...
    difference() {
        ...
        translate([103.4 + ARDUINO_PCB_W + 7, H_BRIDGE_LOWER_W / 2 + 2.3 + 0.6 + (LED_CASE_D - 3) / 2 + 0.15, 74 + ARDUINO_H]) {
            cube([LED_CASE_D - 3, LED_CASE_D - 2, LED_CASE_H]);
        }
    }
    ...
    // support
    difference() {
        plate(l = 10, w = 4 + ARDUINO_BOLT_HOLE_D, h = ARDUINO_H + 24, xt = 103.4 + ARDUINO_PCB_W - 3.5, yt = H_BRIDGE_LOWER_W / 2 + 2.3, zt = 55, color = "DarkViolet");

    plate(l = 4, w = 6 + ARDUINO_BOLT_HOLE_D, h = ARDUINO_H + 21, xt = 103.4 + ARDUINO_PCB_W + 3.5, yt = H_BRIDGE_LOWER_W / 2 + 1.3, zt = 54, color = "DarkViolet");
    ...
    difference() {
        plate(l = 12, w = 3.2 + ARDUINO_BOLT_HOLE_D, h = 4, xt = 103.4 + ARDUINO_PCB_W - 5.5, yt = H_BRIDGE_LOWER_W / 2 + 2.3, zt = 75 + ARDUINO_H, color = "DarkViolet");
